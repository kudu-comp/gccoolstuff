  ...
  <div class="card-grid mb-2">
    ...
    <VCard title="Find the puzzle &amp; find hints">
      ...
      <ul>
        ...
        <li>
          ...
          image on your computer and use <router-link to="/exifscanner">
            EXIF Scanner
    ...
    <VCard title="I got a bunch of random numbers...">
      ...
      <ul>
        ...
        <li>
          ...
          hexadecimal. The used codepage could be one of many. With <router-link to="/textcodes">
            Character &amp; codes
          </router-link>
    ...
    <VCard title="I got a bunch of random letters...">
      ...
      <ul>
        ...
        <li>
          <b>Acronyms</b> - The letters might stand for chemical elements <router-link to="/periodictable">
            (Periodic table)
          </router-link> or
          <router-link to="/countries">
            Countries
          </router-link> or maybe <router-link to="/usastates">
            US States
          </router-link>.
        </li>
        <li>
    ...
    <VCard title="I got a bunch of symbols...">
      ...
      <ul>
        <li>
          <b>Codebook</b> - search the <router-link to="/codebook">
            Code book
          </router-link> to see if there is a match.
        </li>
        <li>
          <b>Special fonts</b> - or try <router-link to="/fonts">
            Special fonts
          </router-link> to see if there is a match.
        </li>
        <li>
    ...
    <VCard title="I only got an image...">
      ...
      <ul>
        ...
        <li>
          <b>Image information</b> - also called EXIF data. <router-link to="/exifscanner">
            EXIF Scanner
        ...
        <li>
          ...
          The code might be hidden somewhere in these stats. Try <router-link to="/pixeldata">
            Pixel Data
          </router-link>.
        </li>
      </ul>
      <p>
        <b>Steganography</b> - is the art of encrypting a message within an image. There are many different ways. Here are some of the most common ways and how GCTools can help you find and hide secret messages.
      </p>
      <ul>
        <li><b>Text hidden in a file</b> - For some files text an just be added. For example overwriting a few bytes in a bitmap or WAV sound file won't be noticed. Try the <router-link to="/textextractor">Text in File Tool</router-link>. This will easily find readable text hidden in any file. 
        </li>
        <li>
          ...
          on a slightly different red background. Use <router-link to="/filltool">
            Color Editor
          </router-link> to quickly fill an area and reveal those messages.
        </li>
        <li>
          <b>Bitplanes</b> - Data might be hidden in unused bits (als known as LSB or Least Significant Bits). The <router-link to="/bitplane">Bitplane</router-link> tool is a great way of checking the image.
        </li>
        <li>
          <b>Appended data</b> - The data might be appended after the end of file. Try the <router-link to="/dataappended">Append File Tool</router-link>. This will check many different files for added data. 
        </li>
        <li>
          <b>PNG Chunks</b> - For PNG files there can be text chunks added to the file. The <router-link to="/pngchunk">PNG Metadata editor</router-link> will show you.
        </li>
      </ul>
      <p>
