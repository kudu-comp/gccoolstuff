...
const defsearch = 2 // Default to Name search (index 4 in cols)
const phsearch = computed(() => t('countries.ph'))
...
const cols = computed(() => [
  ...
  { 
    field: "cnum", 
    label: t('countries.cnum'), 
    sortable: true, 
    width: "7%",
    matchCol: (c) => rows.findIndex(e => parseInt(e.cnum) === parseInt(c))
  },
  { 
    field: "name", 
    ...
    sortable: true, 
    width: "20%",
    // Dynamically translate country name based on ISO code
    computed: (r) => t('countries.names.' + r.ccode3.toLowerCase())
  },
  { field: "tel", label: t('countries.tel'), sortable: true, width: "7%" },
  { field: "cur", label: t('countries.cur'), sortable: true, width: "15%" },
  { 
    field: "ccur", 
    label: t('countries.ccur'), 
    sortable: true, 
    width: "7%",
    parseCol: (s) => s.match(/([A-Za-z]{3}[\s]*)/g)
  },
  { field: "lcp", label: t('countries.lcp'), sortable: true, width: "7%" }
])
...
const rows = [
  ...
  { ccode3: "BVT", web: "--", ccode2: "BV", cnum: "074", tel: "--", cur: "--", ccur: "--", lcp: "none" },
  ...
  { ccode3: "RWA", web: "rw", ccode2: "RW", cnum: "646", tel: "250", cur: "frank", ccur: "RWF", lcp: "RWA" },
