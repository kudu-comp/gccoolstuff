    ...
    runChecksum : function () {
      ...
      try {
        ...
        if (this.checksel === "7") {
          ...
          // Write the result
          this.result = this.$t('compcsum.checkres') + s;
          return;
        }
        ...
        this.result = this.$t('compcsum.checkres'); //"The checksum is: ";
        ...
        switch (this.checksel) {
          ...
          case "8":
            if (sum % 2 === 0) {
              this.result += this.$t('compcsum.checkpar1'); // "0 (even parity) or 1 (odd parity)";
            } else {
              this.result += this.$t('compcsum.checkpar2'); //"1 (even parity) or 0 (odd parity)";
            }
            break;
          default:
            break;
