...
const routes = [
  ...
  { path: "/morsecode",           name: 'MorseCode',             component: () => import('@/components/codes/MorseCode.vue')},
  { path: "/vanitycode",          name: 'VanityCode',            component: () => import('@/components/codes/VanityCode.vue')},
  ...
  { path: "/formulasolver",       name: 'FormulaSolver',         component: () => import('@/components/math/FormulaSolver.vue')},
  ...
  { path: "/sequences/:seq?",     name: 'Sequences',             component: () => import('@/components/math/Sequences.vue') },
  ...
  { path: "/truthtable",          name: 'TruthTable',            component: () => import('@/components/comp/TruthTable.vue') } ,
  { path: "/passwordgen",         name: 'PasswordGen',           component: () => import('@/components/comp/PasswordGen.vue') } ,
  { path: "/wordle",              name: 'Wordle',                component: () => import('@/components/games/Wordle.vue') },
  { path: "/dictsearch",          name: 'DictSearch',            component: () => import('@/components/games/DictSearch.vue') },
  { path: "/anagrams",            name: 'Anagrams',              component: () => import('@/components/games/Anagrams.vue') },
  { path: '/sudokusolv',          name: 'SudokuSolv',            component: () => import('@/components/games/SudokuSolv.vue')      },
  { path: '/mmsolver',            name: 'MMSolver',              component: () => import('@/components/games/MMSolver.vue') },
  { path: '/wordsearch',          name: 'WordSearch',            component: () => import('@/components/games/WordSearch.vue') },
  ...
  { path: '/bitplane',            name: 'BitPlane',              component: () => import('@/components/images/BitPlane.vue')         },
  { path: '/dataappended',        name: 'DataAppended',          component: () => import('@/components/images/DataAppended.vue')     },
  { path: '/pngchunk',            name: 'PngChunk',              component: () => import('@/components/images/PngChunk.vue')         },
  { path: '/barcode',             name: 'Barcode',               component: () => import('@/components/images/Barcode.vue')    },
  ...
  { path: "/helpgames",           name: 'GamesIntro',            component: () => import('@/components/games/GamesIntro.vue') },
